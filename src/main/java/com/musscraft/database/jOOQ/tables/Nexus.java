...
public class Nexus extends TableImpl<NexusRecord> {
    ...
    private static final long serialVersionUID = -246951341;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.NEXUS_NEXUS_CREATORUID_UINDEX, Indexes.NEXUS_NEXUS_NAME_UINDEX, Indexes.NEXUS_NEXUS_UID_UINDEX, Indexes.NEXUS_PRIMARY);
    }
    ...
    public List<UniqueKey<NexusRecord>> getKeys() {
        return Arrays.<UniqueKey<NexusRecord>>asList(Keys.KEY_NEXUS_PRIMARY, Keys.KEY_NEXUS_NEXUS_UID_UINDEX, Keys.KEY_NEXUS_NEXUS_NAME_UINDEX, Keys.KEY_NEXUS_NEXUS_CREATORUID_UINDEX);
    }
